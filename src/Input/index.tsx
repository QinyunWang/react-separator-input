...
const withSeparator = <P extends object>(Component: React.ComponentType<P> | 'input') => function SeparatorInput (props: P & SeparatorInputProps) {
  const {
    precision,
    decimalSeparator = '.',
    thousandSeparator = '',
  ...
  const getValueGroup = (value: any, stage: 'change' | 'blur'): {
    ...
    const formattedValue = format(numberValueStr, thousandSeparator, decimalSeparator, stage, precision)
